...
public class SwerveModule extends SubsystemBase implements Consts{
    ...
    public SwerveModule(int drivePort, int steeringPort) {
        ...
        m_steeringMotor.getEncoder().setPositionConversionFactor(ChassisValues.STEERING_GEAR_RATIO * 360); // degrees and
                                                                                                          // gear ratio

        // take care of speed motor velocity gear velocity
        m_driveMotor.getEncoder()
                .setVelocityConversionFactor(ChassisValues.DRIVE_GEAR_RATIO * ChassisValues.WHEEL_PERIMETER / 60.0); // convert
                                                                                                                   // from
                                                                                                                   // rpm
                                                                                                                   // to
                                                                                                                   // m/s
        ...
        m_driveMotor.getEncoder()
                .setPositionConversionFactor(ChassisValues.DRIVE_GEAR_RATIO * ChassisValues.WHEEL_PERIMETER);
